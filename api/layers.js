...
router.get('/:worldName', (req, res) => {
    axios.get(`http://localhost:8080/geoserver/rest/workspaces/${req.params.worldName}/layers.json`, { headers: { Authorization } })
        .then((response) => {
...
router.get('/:worldName/:layerName', (req, res) => getLayerResource (req, res, req.params.worldName, req.params.layerName));
